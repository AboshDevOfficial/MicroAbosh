...
class Utils
{
    ...
    public static function colorIntoTerracotta(string $color) : int{
        return self::TERRACOTTA_COLOR[$color];
    }
    
    public static function colorIntoGlass(string $color) : int{
        return self::GLASS_COLOR[$color];
    }
    ...
    public static function woolIntoColor(int $woolDamage) : string{
        ...
        public static function terracottaIntoColor(int $terracottaDamage) : string{
        $replace = [
            '§a' => 5,
            '§c' => 14,
            '§e' => 4,
        ...
        return array_search($terracottaDamage, self::TERRACOTTA_COLOR);
    }
    
    public static function glassntoColor(int $glassDamage) : string{
        $replace = [
            '§a' => 5,
            '§c' => 14,
            '§e' => 4,
        ...
        return array_search($glassDamage, self::GLASS_COLOR);
    }
